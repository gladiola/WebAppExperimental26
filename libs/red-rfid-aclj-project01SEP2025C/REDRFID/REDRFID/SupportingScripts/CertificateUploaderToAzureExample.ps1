...
# Define variables
$vaultName = "RED-RFID-CapstoneC"
$certificateName = "server"
$pfxFilePath = "C:\Users\gladi\onmachine\intermediate\certs\redrfid-hphjgve4caapewc4.full.pfx"  # Update with your file path
$plainPassword = "owe_swank_sykes_rash_orgy_hide_gaur_solon_mel"  # Update with your PFX password
